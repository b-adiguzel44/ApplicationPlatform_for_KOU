...
userModel(){
  ...
  Future<MyUser?> signInWithEmailAndPassword(String email, String password, String pozisyon) async {
    try{
      ...
      _user = (await _userRepostory.signInWithEmailAndPassword(email, password,pozisyon))!;
      return _user;
  ...
  Future<MyUser?> createUserWithEmailAndPassword(String email, String password,String pozisyon) async{
    try{
      state=ViewState.Busy;
      _user= (await _userRepostory.createUserWithEmailAndPassword(email, password,pozisyon))!;
      return _user;
  ...
  Future<bool> UptadeUserAd(String UserId, String UserAd,String UserSoyad, String UserAdres) async
  {
   bool sonuc;
   sonuc = await _userRepostory.UpdateUserName(UserId,UserAd,UserSoyad,UserAdres);
   return sonuc;
  }
  @override
