...
class DersIntibakForm extends StatefulWidget {
  const DersIntibakForm({Key? key}) : super(key: key);

  @override
  _DersIntibakFormState createState() => _DersIntibakFormState();
}

class _DersIntibakFormState extends State<DersIntibakForm> {
  ...
  String adres = "YAZIŞMA ADRESİ";    // yes
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Ders İntibakı Başvuru Form'), centerTitle: true),
      body: Stepper(
        key: _formKey,
