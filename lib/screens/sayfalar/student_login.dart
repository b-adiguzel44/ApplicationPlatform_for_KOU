...
class _StudentLoginState extends State<StudentLogin> {
  ...
  Widget build(BuildContext context) {
    ...
    _formSubmit(BuildContext context) async{
      ...
      {
      if(await _userModel.signInWithEmailAndPassword(_email!, _sifre!,_girisYapanPozisyon)!= null)
        {
      ...
      {
        if(await _userModel.createUserWithEmailAndPassword(_email!, _sifre!,_girisYapanPozisyon)!= null)
        {
